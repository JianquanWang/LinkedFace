...
<div id="right_ctn">
    <div class="right_m">
        <div class="hy_list">
            <div class="box_t">
                <span class="name">Add Person</span>
            </div>
            <div class="space_hx">&nbsp;</div>
            <form action="add.do" method="post" name="addForm" enctype="multipart/form-data">
                <div class="xjhy">
                    <!--高级配置-->
                    <ul class="hypz gjpz clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="linkedinUri" type="text">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="organization" type="text">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
